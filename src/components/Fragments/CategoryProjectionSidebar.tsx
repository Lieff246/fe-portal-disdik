                ...
                <div className="flex items-center gap-4">
                  {tabs.map((tab) => (
                    <button
                      ...
                      className={`px-8 py-4 rounded-2xl flex items-center gap-4 transition-all border ${activeTab === tab.id
              ...
              {filteredItems.map((item, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div
                      className={`px-4 py-1.5 rounded-full text-sm mb-3 ${item.status === "realized"
