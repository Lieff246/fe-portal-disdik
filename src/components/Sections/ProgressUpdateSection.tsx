...
export const ProgressUpdateSection: React.FC<Props> = ({}) => {
  ...
  return (
    <section className="w-full pb-8">
      ...
      <div className="bg-white/30 backdrop-blur-[1px] border border-white/50 mt-4 rounded-[2rem] p-10 shadow-2xl shadow-slate-200/10 flex flex-col gap-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/10 backdrop-blur-md border border-emerald-100/50 rounded-[2.5rem] p-8 flex flex-col gap-2">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-amber-100/50 rounded-[2.5rem] p-8 flex flex-col gap-2">
            <div className="flex items-center gap-3">
