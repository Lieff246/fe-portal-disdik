...
export const GeneralDataSection: React.FC<Props> = ({ data }) => {
  ...
  return (
    <section className="w-full ">
      ...
      <div className="bg-white/30 backdrop-blur-[1px] border border-white/50 rounded-[2rem] px-8 py-6 shadow-2xl shadow-slate-200/10 relative z-10">
        ...
        <div className="flex  justify-between">
          {stats.map((item, idx) => (
            <div key={idx} className="flex rounded-2xl bg-[#F8FCFF]/80 p-4 items-center gap-5 group">
              <div
